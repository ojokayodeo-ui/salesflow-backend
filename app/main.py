...
from app.routers import email, webhook, pipeline, crm, calendly, analytics, nurture, mail, agent, agents, settings
...
@app.get("/")
def root():
    return {"status": "PALM backend running", "version": "3.6.0"}
